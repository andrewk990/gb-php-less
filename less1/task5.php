<?php
	...
	// Объявляем переменные (br_lesson1)
	$hTitle = 'Task 4*';
...
<body>
	<div id="content">
		...
		<div id="footer">
			<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija  <br> </a> <?= "Текуща дата: $yBasementFooter" ?></p>
		</div>	
	</div>
</body>
</html>